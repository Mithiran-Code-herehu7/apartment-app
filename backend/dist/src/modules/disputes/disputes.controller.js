...
__decorate([
    (0, common_1.Post)(),
    (0, swagger_1.ApiOperation)({ summary: 'Open a dispute for a booking' }),
    (0, swagger_1.ApiResponse)({ status: 201, description: 'Dispute opened successfully' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Get all disputes involving the current user' }),
